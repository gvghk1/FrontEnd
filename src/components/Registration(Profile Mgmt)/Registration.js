    ...
    return (
      <div className="">
        <form name = "form1" onsubmit="return check_entries(input, cc_num)">
          ...
          <a href="file:///C:/Users/Paul/Desktop/Sample/LoginPage.html">Already have an account? Click here to login.</a> <br/>
          ...
          <div class = "form-header">
              ...
              (You will be able to add more addresses once your account has been created) <br/>
          </div>
          ...
          <div class = "form-header">
              ...
              (You will be able to add more credit cards once your account has been created) <br/>
          </div>
          ...
          CVV: <input type="text" id="cc_cvv" required/> <br/> <br/>
            ...
            <input type = "submit" value="Submit" onclick="check_entries(document.form1.Password, document.form1.cc_number);"/>
          </form>
      </div>
    );
  }
